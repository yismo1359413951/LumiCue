...
struct ConfigAccessView: View {
  ...
  @State private var isGranted = !LumiCueConfigurationService.shared.needsUserSelectedConfigAccess
  ...
  private func grantAccess() {
    ...
    do {
      guard let result = try LumiCueConfigurationAccessGranting.grantSuggestedConfigAccess(
        service: service,
  ...
  private func autoImportFailureMessage(for result: LumiCueConfigurationAutoImportResult) -> String {
