...
struct SponsorView: View {
  ...
  private var localizedSponsorLinks: [SponsorLink] {
    [
      SponsorLink(
        ...
        color: .pink,
        url: URL(string: "https://github.com/yismo1359413951/LumiCue")!
      ),
      SponsorLink(
        id: "ko-fi",
        title: "Ko-fi",
  ...
  private var sponsorDescription: String {
    onboardingLocalization.string(
      ...
      defaultValue: "If LumiCue saves you time, supporting the project helps keep it independent and improving.",
  ...
  private var sponsorOptionalNote: String {
    onboardingLocalization.string(
      ...
      defaultValue: "Completely optional. LumiCue stays fully usable either way.",
