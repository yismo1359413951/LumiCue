  ...
  private var heroSection: some View {
    VStack(spacing: Spacing.md) {
      ...
      HStack(spacing: Spacing.md) {
        Link(destination: URL(string: "https://lumicue.app")!) {
        ...
        Link(destination: URL(string: "https://github.com/yismo1359413951")!) {
        ...
        Link(destination: URL(string: "https://github.com/yismo1359413951/LumiCue/issues")!) {
