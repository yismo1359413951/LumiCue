...
private enum TeleprompterScriptSanitizer {
  ...
  nonisolated static func shouldRunEditPasteProbe() -> Bool {
    ProcessInfo.processInfo.environment["LUMICUE_TELEPROMPTER_PROBE_EDIT_PASTE"] == "1"
  }

  nonisolated static func isDebugLoggingEnabled() -> Bool {
    ProcessInfo.processInfo.environment["LUMICUE_TELEPROMPTER_LOG_RENDER"] == "1"
  }

  nonisolated static func shouldAutopasteClipboardOnLaunch() -> Bool {
    ProcessInfo.processInfo.environment["LUMICUE_TELEPROMPTER_AUTOPASTE_CLIPBOARD"] == "1"
  }
