...
private let recordingMetadataLogger = Logger(subsystem: "LumiCue", category: "RecordingMetadata")
...
enum RecordingMetadataStore {
  ...
  private static let appSupportFolderName = "LumiCue"
  ...
  private static let legacySidecarExtension = "lumicue-recording.json"
