  ...
  var guidance: ScrollingCaptureSelectionGuidance {
    ...
    case .holdSteady:
      return ScrollingCaptureSelectionGuidance(
        ...
        detail: L10n.ScrollingCapture.guidanceLumiCueLockingFirstFrame,
        tone: .progress
      )
    case .slowDown:
      return ScrollingCaptureSelectionGuidance(
        title: L10n.ScrollingCapture.guidanceSlowDown,
        detail: L10n.ScrollingCapture.guidanceKeepOneDirectionSoLumiCueCanRealign,
        tone: .warning
      )
    case .keepSteadierPace:
      return ScrollingCaptureSelectionGuidance(
    ...
    case .lockingCurrentCapture:
      return ScrollingCaptureSelectionGuidance(
        ...
        detail: L10n.ScrollingCapture.guidanceLumiCueSealingStitchedResult,
        tone: .progress
      )
    case .savingLongScreenshot:
      return ScrollingCaptureSelectionGuidance(
