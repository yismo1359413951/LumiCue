...
private let logger = Logger(subsystem: "LumiCue", category: "TempCaptureManager")
...
final class TempCaptureManager {
  ...
  /// Temp directory for unsaved captures (Application Support/LumiCue/Captures/).
  ...
  let tempCaptureDirectory: URL = {
    guard let appSupport = FileManager.default.urls(
      ...
      let fallback = FileManager.default.temporaryDirectory
        .appendingPathComponent("LumiCue_Captures", isDirectory: true)
