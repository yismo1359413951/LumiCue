...
enum CloudKeychainItem {
  ...
  var account: String {
    switch self {
    case .accessKey:
      return "com.yismo.lumicue.cloud.accessKey"
    case .secretKey:
      return "com.yismo.lumicue.cloud.secretKey"
    case .passwordHash:
      return "com.yismo.lumicue.cloud.passwordHash"
    }
  }
  ...
  var legacyAccounts: [String] {
    switch self {
    case .accessKey:
      return ["com.lumicue.cloud.accessKey"]
    case .secretKey:
      return ["com.lumicue.cloud.secretKey"]
    case .passwordHash:
      return []
    }
  }
...
struct CloudKeychainStore {
  ...
  private static let logger = Logger(subsystem: "LumiCue", category: "CloudKeychainStore")
  private static let currentService = "com.yismo.lumicue.cloud"
  private static let legacyService = "com.lumicue.cloud"
