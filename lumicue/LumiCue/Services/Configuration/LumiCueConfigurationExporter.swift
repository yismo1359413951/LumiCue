//
//  LumiCueConfigurationExporter.swift
//  LumiCue
//
...
@MainActor
enum LumiCueConfigurationExporter {
  ...
  private static func writeCapture(_ writer: inout SimpleTOMLWriter, defaults: UserDefaults) {
    ...
    writer.value("include_lumicue", defaults.boolValue(PreferencesKeys.screenshotIncludeOwnApp, default: false))
  ...
  private static func writeRecording(_ writer: inout SimpleTOMLWriter, defaults: UserDefaults) {
    ...
    writer.value("include_lumicue", defaults.boolValue(PreferencesKeys.recordingIncludeOwnApp, default: false))
    ...
    writer.value("color", LumiCueConfigurationColor.hexString(from: color))
