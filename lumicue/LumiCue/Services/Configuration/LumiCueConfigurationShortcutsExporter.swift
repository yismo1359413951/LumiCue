//
//  LumiCueConfigurationShortcutsExporter.swift
//  LumiCue
//
...
@MainActor
extension LumiCueConfigurationExporter {
  ...
  private static func writeOverlayShortcut(
    ...
    writer.value("key", LumiCueConfigurationShortcutCodec.exportKey(config))
    writer.stringArray("modifiers", LumiCueConfigurationShortcutCodec.exportModifiers(config))
  }
