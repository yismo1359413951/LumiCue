...
//  LumiCue
//
//  Core logging engine — appends to daily .txt files in ~/Library/Logs/LumiCue/
//
...
final class DiagnosticLogger {
  ...
  private let logDirectoryName = "LumiCue"
  private let filePrefix = "lumicue_"
  private let fileExtension = "txt"

  // MARK: - State

  private let writeQueue = DispatchQueue(label: "com.yismo.lumicue.diagnosticlogger", qos: .utility)
  ...
  private func writeSessionHeader() {
    ...
    let header = """
      ...
      \(osString) | LumiCue \(appVersion) (\(buildNumber)) | \(cpuArch)
