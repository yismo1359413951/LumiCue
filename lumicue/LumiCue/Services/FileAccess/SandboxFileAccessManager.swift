...
private let logger = Logger(subsystem: "LumiCue", category: "SandboxFileAccess")
...
final class SandboxFileAccessManager {
  ...
  var defaultExportDirectory: URL {
    if let desktop = FileManager.default.urls(for: .desktopDirectory, in: .userDomainMask).first {
      return desktop.appendingPathComponent("LumiCue", isDirectory: true)
    }
    return FileManager.default.homeDirectoryForCurrentUser.appendingPathComponent("LumiCue", isDirectory: true)
  }
