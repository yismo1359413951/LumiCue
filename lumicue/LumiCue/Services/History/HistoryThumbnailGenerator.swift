...
private let logger = Logger(subsystem: "LumiCue", category: "HistoryThumbnailGenerator")
...
final class HistoryThumbnailGenerator {
  ...
  private let workerQueue = DispatchQueue(
    label: "lumicue.history-thumbnail-generator.worker",
    qos: .utility,
    attributes: .concurrent
  )
  private let thumbnailsDirectoryURL: URL
  private let stateQueue = DispatchQueue(label: "lumicue.history-thumbnail-generator.state")
