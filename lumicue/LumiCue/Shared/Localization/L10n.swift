...
enum L10n {
  ...
  enum VideoEditor {
    ...
    static let followMouseOnlyWorksWithLumiCue = string(
      "video-editor.follow-mouse-only-works-with-lumicue",
  ...
  enum ScrollingCapture {
    ...
    static let guidanceLumiCueLockingFirstFrame = string(
      "scrolling-capture.guidance-lumicue-locking-first-frame",
    ...
    static let guidanceKeepOneDirectionSoLumiCueCanRealign = string(
      "scrolling-capture.guidance-keep-one-direction-so-lumicue-can-realign",
    ...
    static let guidanceLumiCueSealingStitchedResult = string(
      "scrolling-capture.guidance-lumicue-sealing-stitched-result",
