//
//  LumiCueConfigurationImporterTests.swift
//  LumiCueTests
//
...
@MainActor
final class LumiCueConfigurationImporterTests: XCTestCase {
  func testImportAppliesCaptureAndRecordingSettingsToProvidedDefaults() {
    ...
    let result = LumiCueConfigurationImporter.importTOML(source, defaults: defaults)
  ...
  func testImportExpandsTildePathsAgainstUserHomeDirectory() {
    ...
    XCTAssertEqual(
      ...
      LumiCueConfigurationPaths.expandedUserPath("~/Desktop")
    )
  }
