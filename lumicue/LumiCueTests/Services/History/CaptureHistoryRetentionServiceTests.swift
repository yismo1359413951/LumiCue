...
final class CaptureHistoryRetentionServiceTests: XCTestCase {
  ...
  override func setUp() {
    ...
    tempDirectory = FileManager.default.temporaryDirectory
      .appendingPathComponent("LumiCueTests_CaptureHistoryRetention_\(UUID().uuidString)", isDirectory: true)
    ...
    defaultsSuiteName = "LumiCueTests.CaptureHistoryRetentionServiceTests.\(UUID().uuidString)"
