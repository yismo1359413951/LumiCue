...
final class CaptureHistoryStoreTests: XCTestCase {
  ...
  override func setUp() {
    super.setUp()
    defaultsSuiteName = "LumiCueTests.CaptureHistoryStoreTests.\(UUID().uuidString)"
    ...
    testDirectory = FileManager.default.temporaryDirectory
      .appendingPathComponent("LumiCueTests_CaptureHistoryStore_\(UUID().uuidString)", isDirectory: true)
