...
APP_NAME="LumiCue"
DEBUG_BUNDLE_NAME="LumiCue Debug"
SCHEME="LumiCue"
PROJECT="LumiCue.xcodeproj"
LOG_SUBSYSTEM="${LOG_SUBSYSTEM:-LumiCue}"
...
${BOLD}Modes:${NC}
  run                 Kill, build, and launch LumiCue.app (default)
  --logs, logs        Launch then stream unified logs for process == "LumiCue"
  ...
  --verify, verify    Launch and confirm the LumiCue process is running
