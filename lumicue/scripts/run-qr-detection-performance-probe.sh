...
TMP_ROOT="${TMPDIR:-/tmp}"
BINARY_PATH="${TMP_ROOT%/}/lumicue-qr-detection-probe"
MODULE_CACHE_PATH="${TMP_ROOT%/}/lumicue-qr-probe-module-cache"
STDERR_PATH="${TMP_ROOT%/}/lumicue-qr-detection-probe.stderr"
