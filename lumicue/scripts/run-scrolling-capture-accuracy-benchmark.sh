...
TMP_ROOT="${TMPDIR:-/tmp}"
BINARY_PATH="${TMP_ROOT%/}/lumicue-scroll-capture-accuracy-benchmark"
MODULE_CACHE_PATH="${TMP_ROOT%/}/lumicue-scroll-benchmark-module-cache"
STDERR_PATH="${TMP_ROOT%/}/lumicue-scroll-capture-accuracy-benchmark.stderr"
...
swiftc -parse-as-library \
  ...
  LumiCue/Services/Capture/ScrollingCapture/ScrollingCaptureStitcher.swift
