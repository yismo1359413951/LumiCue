#!/bin/bash
# Run the LumiCue XCTest suite with CI-like local settings.
#
# Usage:
#   ./scripts/run-tests.sh
#   ./scripts/run-tests.sh -only-testing:LumiCueTests/SomeTests
...
Examples:
  $0
  $0 -only-testing:LumiCueTests/CaptureOutputNamingTests
  LUMICUE_RUN_MICROPHONE_INTEGRATION=1 $0 -only-testing:LumiCueTests/MicrophoneAudioCapturerTests/testMicrophoneAudioCapturerStartStopRealMicrophoneIntegration
EOF
}
