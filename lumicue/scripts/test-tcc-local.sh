...
build_archive() {
  ...
  local archive_path="$TEST_DIR/$version_label/LumiCue.xcarchive"
...
sign_and_install() {
  ...
  local archive_path="$TEST_DIR/$archive_label/LumiCue.xcarchive"
  local app_path="$TEST_DIR/$version_label/LumiCue.app"
