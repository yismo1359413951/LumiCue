...
#
# Example:
#   ./scripts/update-appcast.sh "1.2.3" "42" "build/LumiCue-v1.2.3.dmg" "appcast.xml" "abc123..." "<h3>Features</h3><ul><li>New feature</li></ul>"
#
...
# Download URL
DOWNLOAD_URL="https://github.com/yismo1359413951/LumiCue/releases/download/v${VERSION}/LumiCue-v${VERSION}.dmg"
