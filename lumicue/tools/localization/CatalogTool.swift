...
func loadManifest() throws -> Manifest {
  let manifestURL = repoRoot.appendingPathComponent("LumiCue/Resources/Localization/manifest.json")
...
func extractL10nKeys() throws -> Set<String> {
  let localizationRoot = repoRoot.appendingPathComponent("LumiCue/Shared/Localization")
...
func extractL10nTableMappings() throws -> [String: String] {
  let l10nURL = repoRoot.appendingPathComponent("LumiCue/Shared/Localization/L10n.swift")
