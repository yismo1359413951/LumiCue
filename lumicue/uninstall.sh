#!/usr/bin/env bash
# uninstall.sh — Completely remove LumiCue and reset ALL related permissions
#
# Usage:
...
#   2. Removes LumiCue.app from /Applications
...
APP_NAME="LumiCue"
APP_PATH="/Applications/LumiCue.app"
FALLBACK_BUNDLE_ID="com.yismo.lumicue"
...
# ─── 8. Login items ─────────────────────────────────────────────
# NOTE: sfltool resetbtm resets ALL apps' login items, not just LumiCue.
...
# LumiCue does NOT use App Sandbox. If a container exists, it's from
...
echo -e "${GREEN}║  https://github.com/yismo1359413951/LumiCue/releases   ║${NC}"
echo -e "${GREEN}╚══════════════════════════════════════════════════════╝${NC}"
echo ""
